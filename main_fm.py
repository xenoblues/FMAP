...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='MotionTransformer')
    ...
    parser.add_argument('--ckpt', type=str, default='./results/he/models/ckpt_ema_500.pt', help='./results/h36m/models/ckpt_ema_1000.pt' or './results/he/models/ckpt_ema_500.pt')
    ...
    parser.add_argument("--ode_options", default='{"step_size": 0.05}', type=json.loads, help="ODE solver options. Eg. the midpoint solver requires step-size, dopri5 has no options to set.")
